...
class LinearCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "4f7591593f18220dcc4868513f98b5b89023cce0ad2c067defdb67ca9a1a1dfc"
    end
    on_intel do
      url "https://github.com/joa23/linear-cli/releases/download/v#{version}/linear-cli_Darwin_x86_64.tar.gz"
      sha256 "79fb5f7d92d4f680e1dca31ecb26a19c97435aca33d99f774904f8dce8d134c4"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "7deeae3e39bde1a53d6c631032e7d966530cad6d8b61c949129bd90d5094224d"
    end
    on_intel do
      url "https://github.com/joa23/linear-cli/releases/download/v#{version}/linear-cli_Linux_x86_64.tar.gz"
      sha256 "f8fb675cb5a70b9c87aaaea4199309a9f1ff7f37d94d869c480d14437a184af4"
    end
  end
